...
if [[ $overwrite == "y" || $overwrite == "Y" ]]; then
  ...
  # --------- Finalize genesis ---------
  evmd genesis gentx "$VAL_KEY" 1000000000000000000000atest --min-self-delegation "1000000" --gas-prices ${BASEFEE}atest --keyring-backend "$KEYRING" --chain-id "$CHAINID" --home "$CHAINDIR"
